-- JG_TrackHeight_116.lua
-- Set all tracks to 116px height, center selected track vertically
...
-- Get arrange window and visible height
...
-- Measure ruler offset at scroll pos 0
...
-- Calculate and set target scroll
...
reaper.Undo_EndBlock("Set all track heights to 116px", -1)
